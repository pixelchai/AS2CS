    ...
    public class ASLexer : RegexLexer
    {
        ...
        protected override IDictionary<string, StateRule[]> GetStateRules()
        {
            ...
            rules["root"] = builder.NewRuleSet()
                ...
                .Add(@"(case|default|for|each|in|while|do|break|return|continue|if|else|throw|try|catch|with|new|typeof|arguments|instanceof|this|switch|import|include|as|is)\b", TokenTypes.Keyword)
